...
public class POM_Reusable_Actions_Loggers {
    ...
    public static void selectByText(WebDriver driver,WebElement xpath, String contains,ExtentTest logger, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,timeout);
        try {
            WebElement element = wait.until(ExpectedConditions.visibilityOf(xpath));
            Select elements = new Select(driver.findElement((By) xpath));
            element.click();
    ...
    public static void scrollToAction(WebDriver driver,WebElement xpath,ExtentTest logger, String elementName){
        WebDriverWait wait = new WebDriverWait(driver, timeout);
    ...
    public static void visibilityOfElement(WebDriver driver,WebElement xpath,ExtentTest logger, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,timeout);
        boolean elementState = wait.until(ExpectedConditions.visibilityOf(xpath)).isDisplayed();
        try {
    ...
    public static void presenceOfElement(WebDriver driver,WebElement xpath,ExtentTest logger, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,timeout);
        boolean elementState = wait.until(ExpectedConditions.presenceOfElementLocated((By) xpath)).isDisplayed();
        try {
            if (elementState == true){
                System.out.println("The " + elementName + " is visible.");
                logger.log(LogStatus.PASS,elementName + " is visible.");
